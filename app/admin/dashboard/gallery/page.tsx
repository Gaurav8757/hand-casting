      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-foreground/60 text-lg">
            Curate your premium hand casting portfolio.
          </p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-2xl text-foreground focus:outline-none focus:ring-2 focus:ring-primary/40 transition-all cursor-pointer font-medium appearance-none"
                  >
                    <option value="" className="bg-slate-900">
                      Select...
                    </option>
                    <option value="couples" className="bg-slate-900">
                      Couples
                    </option>
                    <option value="families" className="bg-slate-900">
                      Families
                    </option>
                    <option value="babies" className="bg-slate-900">
                      Baby Molds
                    </option>
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-2xl text-foreground focus:outline-none focus:ring-2 focus:ring-primary/40 transition-all font-bold"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, customerReview: e.target.value })
                  }
                  className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-2xl text-foreground placeholder-foreground/20 focus:outline-none focus:ring-2 focus:ring-primary/40 transition-all resize-none font-medium"
                  rows={2}
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-white/10 bg-white/5">
                    ...
                    <th className="p-6 font-bold text-xs uppercase tracking-widest text-foreground/50 text-center">
                      Exposure
                    </th>
                      ...
                      <td colSpan={5} className="p-20 text-center">
                        <div className="flex flex-col items-center gap-4 text-foreground/30">
                          ...
                          <p className="text-sm max-w-sm mx-auto">
                            Fill it with stunning 3D hand casting artwork to
