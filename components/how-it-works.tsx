    ...
    <section id="how-it-works" className="py-20 px-4 md:px-8 bg-card/50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center space-y-4 mb-12">
          ...
          <p className="text-lg text-foreground/70 max-w-2xl mx-auto">Simple steps to create lasting memories</p>
        </div>
            ...
            return (
              <div key={i} className="relative">
                <div className="glass p-6 text-center space-y-4 h-full">
                  <div className="w-16 h-16 bg-gradient-to-br from-amber-600 to-amber-700 rounded-full flex items-center justify-center mx-auto">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-foreground/70 mt-2">{step.desc}</p>
                  </div>
                </div>
                {i < steps.length - 1 && (
                  <div className="hidden md:block absolute top-1/2 -right-3 w-6 h-1 bg-gradient-to-r from-accent to-transparent" />
                )}
              </div>
            )
          })}
