      ...
      <div className="max-w-4xl mx-auto text-center space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-1000">
        <div className="space-y-4">
          ...
          <p className="text-lg md:text-xl text-foreground/70 text-balance max-w-2xl mx-auto">
            Discover exceptional hand-casting artistry. Each piece is crafted with precision, passion, and decades of
            expertise.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center pt-8">
          ...
          <button className="px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-full hover:shadow-lg active:scale-95 transition-all duration-200">
            Get Started
          </button>
        </div>
